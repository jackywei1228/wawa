...
<dl class="leftmenu">
  <dd>
    ...
    <?php if(($_SESSION['utype']) == "1"): ?><li><cite></cite><a href="<?php echo U('Shuju/index');?>"  target="rightFrame">数据统计</a><i></i></li>
      <li><cite></cite><a href="<?php echo U('Zhuanpan/add');?>"  target="rightFrame">娃娃设置</a><i></i></li><?php endif; ?>
      
      <li><cite></cite><a href="<?php echo U('User/index');?>"  target="rightFrame">用户管理</a><i></i></li>
      <li><cite></cite><a href="<?php echo U('User/hb');?>"  target="rightFrame">娃娃记录</a><i></i></li>
    ...
    <?php if(($_SESSION['utype']) == "1"): ?><li><cite></cite><a href="<?php echo U('User/yongjinjiesuan');?>"  target="rightFrame">佣金结算</a><i></i></li><?php endif; ?>
